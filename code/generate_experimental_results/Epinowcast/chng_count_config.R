...
# ----------------------------------------------------------------
# Configuration for chng outpatient covid insurance claims dataset count forecasting using epinowcast
# ----------------------------------------------------------------
config <- list(
  # ---- Dataset metadata ----
  ...
  # ---- Output directory ----
  export_dir   = "../../../data/results/Epinowcast_result"  # Directory where models and results will be saved
)
