...
df = read_chng_outpatient_result()
...
# subdf = df.loc[(df["geo_value"] == "ca")
#                & (df["lag"] == 3)
#                & (df["Trend"] == "Up")]
# plt.scatter(subdf["time_value"], subdf["wis"], color="red")
# subdf = df.loc[(df["geo_value"] == "ca")
#                & (df["lag"] == 3)
#                & (df["Trend"] == "Down")]
# plt.scatter(subdf["time_value"], subdf["wis"], color="blue")
# subdf = df.loc[(df["geo_value"] == "ca")
#                & (df["lag"] == 3)]
# plt.plot(subdf["time_value"], subdf["wis"], color="gray")
# ###

# plt.figure(figsize=(15, 4))
# plt.plot(subdf["time_value"], subdf["target_7dav_slope"])
# plt.plot(subdf["time_value"], subdf["value_7dav"])
